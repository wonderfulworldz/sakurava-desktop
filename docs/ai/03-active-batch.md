...
next_highest_priority_action: XLSX_VIDEOS_PERFORMER_REFERENCE_FAILURE_CAUSAL_AUDIT
...
xlsx_videos_performer_reference_exact_cause: UNKNOWN
...
xlsx_terrain_completeness_gate: REOPENED_BY_NEW_EVIDENCE
xlsx_executor_continuity_decision: BOUNDED_COMPLETION_REQUIRED
xlsx_all_materially_coupled_export_tests: CLASSIFIED
xlsx_mutation_readiness: NONE_PENDING_VIDEOS_PERFORMER_REFERENCE_CAUSAL_AUDIT
