...
gate_status: XLSX_WORKBOOK_ISOLATED_EVIDENCE_ACCEPTED_SELECTED_EMPTY_UI_EVIDENCE_PENDING
...
next_highest_priority_action: XLSX_SELECTED_EMPTY_UI_ISOLATED_EVIDENCE_VERIFICATION
next_highest_priority_action_status: READY_PENDING_SEPARATE_APPROVAL
next_highest_priority_action_mode: VERIFY
...
xlsx_terrain_completeness_gate: FAIL_FOR_MUTATION_READINESS
xlsx_executor_continuity_decision: BOUNDED_VERIFICATION_EVIDENCE_REQUIRED
xlsx_all_materially_coupled_export_tests: CLASSIFIED
xlsx_mutation_readiness: NONE_PENDING_SELECTED_EMPTY_UI_EVIDENCE
