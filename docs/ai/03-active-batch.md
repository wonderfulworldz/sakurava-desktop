...
next_highest_priority_action: XLSX_VIDEOS_TEST_DEBT_CORRECTION_AND_BOUNDED_FOCUSED_VERIFICATION
...
xlsx_executor_continuity_decision: DETERMINISTIC_TEST_ONLY_CORRECTION_READY
xlsx_all_materially_coupled_export_tests: CLASSIFIED
xlsx_mutation_readiness: TEST_ONLY_CORRECTION_READY
