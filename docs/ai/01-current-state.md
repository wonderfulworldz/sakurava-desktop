...
canonical Project OS recovery. The restored pre-migration material below is
retained as historical continuity only. Any older field labelled `Current`,
any former active batch, and any former permission below this reconciliation
boundary is superseded unless repeated here.
...
manual_smoke: PROTECTED_LOCAL_EVIDENCE_TOP_LEVEL_SAFE_POSTURE_ONLY
live_appdata_access: NONE

project_os_recovery: COMPLETED_AND_ACCEPTED
canonical_authority: CANONICAL_00_07_AUTHORITY_RESTORED
...
windbg: APPROVED_AVAILABLE
windbg_version: 1.2606.22001.0
windbg_acquisition: WINGET_EXACT_MICROSOFT_WINDBG_FROM_OFFICIAL_WINGET_SOURCE
windbg_runtime_attachment: NOT_PERFORMED
process_monitor: APPROVED_AVAILABLE
process_monitor_version: 4.1
process_monitor_acquisition: WINGET_EXACT_MICROSOFT_SYSINTERNALS_PROCESSMONITOR_FROM_OFFICIAL_WINGET_SOURCE
...
cargo_deny: APPROVED_AVAILABLE
cargo_deny_version: 0.20.2
cargo_deny_acquisition: CARGO_INSTALL_LOCKED_OFFICIAL_CRATES_IO
cargo_deny_repository_scan: NOT_PERFORMED
cargo_deny_repository_configuration: NOT_CREATED
knip: APPROVED_AVAILABLE
knip_version: 6.33.0
knip_acquisition: NPM_EXTERNAL_USER_TOOL_OFFICIAL_REGISTRY
knip_repository_scan: NOT_PERFORMED
knip_repository_configuration: NOT_CREATED
specialist_tool_baseline: COMPLETE_FOR_CURRENT_MANDATORY_SET
remaining_specialist_tool_additions: NONE_FOR_CURRENT_MANDATORY_SET
...
video_player_stage_1: COMPLETED_AND_ACCEPTED
video_player_stage_2: COMPLETED_AND_ACCEPTED
video_player_stage_3: PARTIAL_ACCEPTED
video_player_stage_3_closure: COMPLETED_AND_ACCEPTED
video_player_stage_4: DOES_NOT_EXIST

The accepted player uses one dedicated `sakurava-media-host.exe`, one libmpv
playback context/session/source, D3D11 Composition, DirectComposition, and a
WebView2 CompositionController React surface. The engine owns playback truth;
...
- software decode fallback: `UNKNOWN`;
- HEVC hardware decode: `NOT_MEASURABLE_IN_CURRENT_ENVIRONMENT`;
- relative-seek latency: `UNKNOWN`;
- visible result in the OS-selected external application after successful
  native handoff: `UNKNOWN`.

These residual evidence gaps are not known defects.

Other legitimate post-migration state retained as current:

- Project Brain V2 migration is a historical event; its six V2 documents are
  preserved as `SECONDARY_TRANSITIONAL_EVIDENCE` pending separate disposition;
- Adaptive Execution Governance is active;
- Simple Statistics is `COMPLETED_AND_ACCEPTED_WITH_RUNTIME_LIMITATION`;
- Automatic Mini Images is
  `COMPLETED_AND_ACCEPTED_WITH_RUNTIME_LIMITATION`;
- Remove Mini Images is `COMPLETED_AND_ACCEPTED_WITH_RUNTIME_LIMITATION`;
- Global Notification System is
  `COMPLETED_AND_ACCEPTED_WITH_RUNTIME_LIMITATION`, with
...
product_state_updated_at: 2026-08-13
repository_state_recorded_at: 2026-08-13
repository_state_status: CLEAN_AT_ACCEPTED_MANUAL_REGENERATE_DELIVERY_COMMIT
repository_state_evidence: REPORTED_BY_CODEX
...
last_recorded_baseline: 2992b69c7d5dad68ad8698eabeefdaf9f837ac1b
baseline_label: Manual-Regenerate-and-Windows-Extended-Path-Delivery-Commit
application_source_baseline: 2992b69c7d5dad68ad8698eabeefdaf9f837ac1b
source_parent: 02bc0b1b47ae21f52bc43db660e7e9420ac5babf
...
project_os_reconciliation_baseline: 515ed4e18f80bf00969f634ad981e017047f7c83
...
decision_stage: NONE
decision_stage_status: NONE
decision_verdict: NONE
current_stage_scope_approval: NONE
...
current_governance_gate: PRE_42_9_ADDITIONAL_FEATURE_REVIEW_REQUIRED
gate_status: MANUAL_REGENERATE_ACCEPTED_FEATURE_QUEUE_REVIEW_REQUIRED_BEFORE_42_9
...
governance_causal_depth_standard: BOUNDED_CAUSAL_DEPTH_COMPLETENESS_BEFORE_MUTATION
terrain_completeness_gate: REQUIRED_BEFORE_FUTURE_TECHNICAL_MUTATION
xlsx_export_corrective_state: COMPLETED_AND_DELIVERED_WITH_RUNTIME_LIMITATION
...
xlsx_anti_loop_state: TECHNICAL_CORRECTION_DELIVERED_DO_NOT_REOPEN_WITHOUT_NEW_EVIDENCE
xlsx_export_progress: 0_OF_1_OUTCOMES_0_PERCENT
xlsx_export_tasks: 6_OF_8_TASKS_75_PERCENT
xlsx_export_delivery_gates: 3_OF_5_GATES_60_PERCENT
xlsx_first_test_root_cause: STALE_TEST_EXPECTATION_PROVEN
xlsx_authorized_test_correction: 5_TO_6_SECTIONS_SELECTED
...
xlsx_causal_audit_classification: XLSX_FAILED_VERIFICATION_CAUSES_CLASSIFIED
xlsx_causal_audit_result_review: XLSX_FAILED_VERIFICATION_CAUSAL_AUDIT_ACCEPTED_WITH_EXECUTION_BOUNDARY_REMAINING
xlsx_videos_csv_header_failure: PRE_EXISTING_TEST_DEBT_PROVEN
xlsx_videos_header_correction: APPLIED_AND_PRESERVED_IN_TECHNICAL_HANDOFF
xlsx_videos_header_verification_boundary: PASSED_BEFORE_DOWNSTREAM_FAILURE
xlsx_videos_performer_reference_failure: EXPECTED_PERFORMER_REFERENCE_MISSING
xlsx_videos_performer_reference_root_cause: MOCK_RELATIONSHIP_DATA_GAP_PROVEN
xlsx_videos_performer_reference_root_cause_evidence: PROVEN_BY_STATIC_SOURCE
xlsx_videos_performer_reference_causal_map: COMPLETE_AND_CLASSIFIED
xlsx_videos_performer_fixture_state: COMPLETED_REPORTED_BY_CODEX
xlsx_videos_csv_production_defect: NOT_SUPPORTED_BY_AVAILABLE_EVIDENCE
xlsx_safe_filter_production_defect: NOT_SUPPORTED_BY_AVAILABLE_EVIDENCE
xlsx_current_handoff_regression: NOT_SUPPORTED_BY_AVAILABLE_EVIDENCE
xlsx_solution_changing_unknowns: NONE_FOR_COMPLETED_TECHNICAL_CORRECTION
xlsx_selected_empty_xlsx_ui_failure: ASYNC_WORKBOOK_BOUNDARY_PRESENT
xlsx_selected_empty_ui_isolated_evidence: PASS_REPORTED_BY_CODEX
xlsx_previous_selected_empty_failure: NOT_REPRODUCED_IN_ISOLATION
xlsx_selected_empty_xlsx_ui_execution_settling_cause: UNKNOWN_NON_SOLUTION_CHANGING_FOR_CURRENT_CORRECTION
xlsx_multi_type_workbook_isolated_evidence: PASS_REPORTED_BY_CODEX
xlsx_multi_type_workbook_isolated_result: XLSX_MULTI_TYPE_WORKBOOK_ISOLATED_EVIDENCE_ACCEPTED
xlsx_multi_type_workbook_test_files: 1_PASS
xlsx_multi_type_workbook_tests: 1_PASS_8_SKIPPED
xlsx_multi_type_workbook_vitest: 4.1.5
xlsx_multi_type_workbook_test_duration: 434ms_REPORTED_BY_CODEX
xlsx_multi_type_workbook_total_duration: 1.38s_REPORTED_BY_CODEX
xlsx_prior_combined_workbook_timeout: NOT_REPRODUCED_IN_ISOLATION
xlsx_prior_combined_timeout_exact_cause: UNKNOWN
xlsx_multi_type_workbook_timeout: NOT_REPRODUCED_IN_ISOLATION
xlsx_multi_type_workbook_timeout_classification: EXECUTION_CAUSE_NOT_STATICALLY_DETERMINABLE
xlsx_workbook_production_mutation_supported: false
xlsx_workbook_timeout_change_supported: false
xlsx_workbook_additional_diagnostic_execution_currently_required: false
xlsx_causal_audit_result: XLSX_FAILED_VERIFICATION_CAUSAL_AUDIT_ACCEPTED_WITH_EXECUTION_BOUNDARY_REMAINING
xlsx_combined_focused_run_exact_cause: UNKNOWN_NON_SOLUTION_CHANGING_FOR_CURRENT_CORRECTION
xlsx_selected_empty_regression_guard: PASS_REPORTED_BY_CODEX
xlsx_terrain_completeness_gate: PASS
xlsx_executor_reporting_noncompliance: NONE_CURRENT_EXECUTION
xlsx_executor_mandatory_work_noncompliance: NONE_CURRENT_EXECUTION
...
xlsx_sheet_selection: ARCHITECTURE_DIRECTION_IDENTIFIED
...
## Current Managed Media and Pre-42.9 Feature Queue Authority — 2026-08-13
...
manual_regenerate_commit: 2992b69c7d5dad68ad8698eabeefdaf9f837ac1b
manual_regenerate_delivery_boundary: 11_EXACT_SOURCE_TEST_PATHS
...
manual_regenerate_progress_visibility_limitation: TOO_BRIEF_FOR_DIRECT_VISUAL_CAPTURE_NOT_A_REOPENING_CONDITION
manual_regenerate_source_handoff: NONE_PENDING
windows_extended_path_correction: ACCEPTED_AND_DELIVERED
windows_extended_path_root_cause: PROVEN_BY_STATIC_SOURCE
windows_extended_path_runtime_evidence: OBSERVED_BY_OPERATOR
...
automatic_mini_images_planning_status: READY_PLANNED_PENDING_SEPARATE_APPROVAL
automatic_mini_images_direction: PERSISTENT_ON_OFF_SETTING_OFF_STOPS_NEW_AUTOMATIC_WORK_PRESERVES_EXISTING_OUTPUTS_MANUAL_REGENERATE_REMAINS_AVAILABLE
simple_statistics_planning_status: READY_PLANNED_PENDING_SEPARATE_APPROVAL
simple_statistics_minimal_direction: MANAGED_MINI_IMAGE_COUNT; TOTAL_MANAGED_MINI_IMAGE_STORAGE_USED; PENDING_PROCESSING_WORK_COUNT; CONCISE_OVERALL_STATUS
remove_mini_images_planning_status: READY_PLANNED_PENDING_SEPARATE_APPROVAL

notification_history_feedback: FEEDBACK-2026-08-13-NOTIFICATION-HISTORY
notification_history_status: PLANNED
notification_history_evidence: OBSERVED_BY_OPERATOR
...
pre_42_9_feature_review_scope: MANAGED_MEDIA_CONTINUATION; NOTIFICATION_HISTORY; VIDEO_PLAYER_CONTACT_SHEET; CENTRALIZED_REMEMBER_POLICY; MINIMAL_CONSISTENT_CATALOG_COLUMNS
pre_42_9_feature_review_decision_status: REVIEW_REQUIRED_BEFORE_42_9_IMPLEMENTATION_PLACEMENT_REMAINS_SEPARATE_OPERATOR_DECISION
...
reconciliation Stage `42.4-9C-I1-C` are `COMPLETED_AND_CLOSED`.
...
The result is `MANAGED_MEDIA_BOUNDED_EXECUTOR_CORE_ACCEPTED` and state
`INERT_BOUNDED_EXECUTOR_CORE`. Canonical executor timestamps, bounded
deterministic discovery, transactional claims and reclaim, renewal, ownership
guards, persisted same-item serialization, and an injected one-cycle executor
are accepted as `REPORTED_BY_CODEX`. The database boundary is released before
handler execution.

I1 does not acquire sources, read source bytes, calculate fingerprints, invoke
the processor, publication, or recovery, modify managed files, run workers,
register startup or shutdown, integrate Tauri, or change frontend,
Import/Export, Backup/Restore, or live AppData behavior. Production worker,
lease, retry, resource, acquisition, foreign-key, provisioning, and
Backup/Restore policies remain `UNKNOWN` or separately gated.
...
I2 has not started and all technical permissions remain false.

## Historical Catalog Lifecycle Integration Authority — 2026-07-29
...
batch_42_3_2a_r1_status: COMPLETED_AND_CLOSED
...
acceptance_startup_db_prepare_median_ms: 35500_APPROXIMATE_R2
...
- Dataset A, 1,000 Works: about 35.5 seconds median in R2.
...
accepted as `TARGETED_MEASUREMENT_PARTIAL_ACCEPTED`. The parent `42.3-2A`
...
behavior, and metadata preservation.
...
- internal startup phases inside `database_prepare`;
- the exact fixture/application validation contract;
- valid Detail and gallery waterfalls;
- actual page-size-256 state and frame behavior;
- phase-specific and steady-state memory;
- repeated missing-source handler counts and metadata preservation.
