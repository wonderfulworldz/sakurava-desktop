...
xlsx_videos_performer_reference_failure_evidence: REPORTED_BY_CODEX
...
recommended_next_technical_action: XLSX_VIDEOS_PERFORMER_REFERENCE_FAILURE_CAUSAL_AUDIT
