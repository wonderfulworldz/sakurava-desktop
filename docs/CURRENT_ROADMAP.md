...
- None / awaiting confirmation. Batch 35.6 is closed at checkpoint `post-mvp-35-6-collection-toolbar-table-finalization-v1`.
...
1. **35.7 - Glossary Library** (planned, not started)
   - Follow `docs/43-final-product-sequential-plan.md`.
   - Do not implement Batch 35.7 work until the batch is explicitly started.
2. **35.8 - Settings System Finalization** (planned)
3. **35.9 - Performance + Translation + Copy Cleanup** (planned)
4. **35.10 - Branding + App Shell + Installer Release Candidate** (planned)
...
- `docs/43-final-product-sequential-plan.md` is the source of truth for Batches 35.7 - 35.10.
